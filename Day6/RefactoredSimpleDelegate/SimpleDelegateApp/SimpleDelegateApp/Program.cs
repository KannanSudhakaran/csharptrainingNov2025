...
namespace SimpleDelegateApp
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Action<int,int> manyOpertionPtr;
            manyOpertionPtr = Add;
            manyOpertionPtr += Sub;
        ...
        static void PrintWizard(Action<string> fnCallback)//function callback
        {
        ...
        {
            Action<string> fnPointer;// expects a function of same signature
